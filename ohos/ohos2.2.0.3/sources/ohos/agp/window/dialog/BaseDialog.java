...
/* loaded from: ohos2.2.0.3.jar:ohos/agp/window/dialog/BaseDialog.class */
public class BaseDialog implements IDialog {

    /* loaded from: ohos2.2.0.3.jar:ohos/agp/window/dialog/BaseDialog$DialogListener.class */
    public interface DialogListener {
        boolean isTouchOutside();
    }

    /* loaded from: ohos2.2.0.3.jar:ohos/agp/window/dialog/BaseDialog$DisplayCallback.class */
    public interface DisplayCallback {
        void onDisplay(IDialog iDialog);
    }

    /* loaded from: ohos2.2.0.3.jar:ohos/agp/window/dialog/BaseDialog$RemoveCallback.class */
