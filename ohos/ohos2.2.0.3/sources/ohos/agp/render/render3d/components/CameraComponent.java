...
/* loaded from: ohos2.2.0.3.jar:ohos/agp/render/render3d/components/CameraComponent.class */
public class CameraComponent implements Component {
    public static final int CAMERA_FLAG_SHADOW_BIT = 1;

    /* loaded from: ohos2.2.0.3.jar:ohos/agp/render/render3d/components/CameraComponent$CameraType.class */
