...
/* loaded from: ohos2.2.0.3.jar:ohos/agp/components/ComponentTreeObserver.class */
public final class ComponentTreeObserver {

    /* loaded from: ohos2.2.0.3.jar:ohos/agp/components/ComponentTreeObserver$GlobalFocusUpdatedListener.class */
    public interface GlobalFocusUpdatedListener {
        void onGlobalFocusUpdated(Component component, Component component2);
    }

    @Deprecated
    /* loaded from: ohos2.2.0.3.jar:ohos/agp/components/ComponentTreeObserver$GlobalLayoutListener.class */
    public interface GlobalLayoutListener {
        @Deprecated
        void onGlobalLayoutUpdated();
    }

    /* loaded from: ohos2.2.0.3.jar:ohos/agp/components/ComponentTreeObserver$ScrollChangedListener.class */
    public interface ScrollChangedListener {
        void onScrolled();
    }

    /* loaded from: ohos2.2.0.3.jar:ohos/agp/components/ComponentTreeObserver$WindowBoundListener.class */
    ...
    /* loaded from: ohos2.2.0.3.jar:ohos/agp/components/ComponentTreeObserver$WindowFocusUpdatedListener.class */
