...
/* loaded from: ohos2.2.0.3.jar:ohos/agp/components/RadioContainer.class */
public class RadioContainer extends DirectionalLayout {
    public static final int INVALID_ID = -1;
    protected CheckedStateChangedListener mMarkListener;

    /* loaded from: ohos2.2.0.3.jar:ohos/agp/components/RadioContainer$CheckedStateChangedListener.class */
