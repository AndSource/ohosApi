...
/* loaded from: ohos2.2.0.3.jar:ohos/bundle/AbilityInfo.class */
public class AbilityInfo implements Sequenceable {
    ...
    /* loaded from: ohos2.2.0.3.jar:ohos/bundle/AbilityInfo$AbilitySubType.class */
    public enum AbilitySubType {
        UNSPECIFIED,
        CA
    }

    /* loaded from: ohos2.2.0.3.jar:ohos/bundle/AbilityInfo$AbilityType.class */
    ...
    /* loaded from: ohos2.2.0.3.jar:ohos/bundle/AbilityInfo$DisplayOrientation.class */
    ...
    /* loaded from: ohos2.2.0.3.jar:ohos/bundle/AbilityInfo$LaunchMode.class */
