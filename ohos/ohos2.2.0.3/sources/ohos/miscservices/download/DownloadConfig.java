...
/* loaded from: ohos2.2.0.3.jar:ohos/miscservices/download/DownloadConfig.class */
public class DownloadConfig implements Sequenceable {
    ...
    /* loaded from: ohos2.2.0.3.jar:ohos/miscservices/download/DownloadConfig$Builder.class */
    public static class Builder {
        ...
        public Builder setDownloadRange(int offset, int size) {
            throw new RuntimeException("Stub!");
        }
