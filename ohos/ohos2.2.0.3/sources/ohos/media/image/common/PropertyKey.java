...
/* loaded from: ohos2.2.0.3.jar:ohos/media/image/common/PropertyKey.class */
public final class PropertyKey {
    PropertyKey() {
        throw new RuntimeException("Stub!");
    }

    /* loaded from: ohos2.2.0.3.jar:ohos/media/image/common/PropertyKey$Exif.class */
    ...
    /* loaded from: ohos2.2.0.3.jar:ohos/media/image/common/PropertyKey$GIF.class */
