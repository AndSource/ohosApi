...
/* loaded from: ohos2.2.0.3.jar:ohos/media/common/AVMetadata.class */
public final class AVMetadata implements Sequenceable {
    ...
    /* loaded from: ohos2.2.0.3.jar:ohos/media/common/AVMetadata$AVLongKey.class */
    ...
    @Retention(RetentionPolicy.CLASS)
    /* loaded from: ohos2.2.0.3.jar:ohos/media/common/AVMetadata$AVPixelMapKey.class */
    public @interface AVPixelMapKey {
        public static final String ICON = "ohos.av.metadata.DISPLAY_ICON";
    }

    @Retention(RetentionPolicy.CLASS)
    /* loaded from: ohos2.2.0.3.jar:ohos/media/common/AVMetadata$AVTextKey.class */
    ...
    /* loaded from: ohos2.2.0.3.jar:ohos/media/common/AVMetadata$Builder.class */
