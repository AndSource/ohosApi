...
/* loaded from: ohos2.2.0.3.jar:ohos/media/audio/AudioWaver.class */
public class AudioWaver {

    /* loaded from: ohos2.2.0.3.jar:ohos/media/audio/AudioWaver$FrequencyDataObserver.class */
    public interface FrequencyDataObserver {
        void onFrequencyData(byte[] bArr, int i);
    }

    /* loaded from: ohos2.2.0.3.jar:ohos/media/audio/AudioWaver$WaveDataObserver.class */
