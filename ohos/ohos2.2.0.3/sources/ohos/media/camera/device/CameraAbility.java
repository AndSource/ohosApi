...
/* loaded from: ohos2.2.0.3.jar:ohos/media/camera/device/CameraAbility.class */
public interface CameraAbility {

    @Retention(RetentionPolicy.CLASS)
    /* loaded from: ohos2.2.0.3.jar:ohos/media/camera/device/CameraAbility$CameraRunningMode.class */
