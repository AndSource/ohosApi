...
/* loaded from: ohos2.2.0.3.jar:ohos/media/camera/params/ParametersResult.class */
public interface ParametersResult {

    @Retention(RetentionPolicy.CLASS)
    /* loaded from: ohos2.2.0.3.jar:ohos/media/camera/params/ParametersResult$State.class */
