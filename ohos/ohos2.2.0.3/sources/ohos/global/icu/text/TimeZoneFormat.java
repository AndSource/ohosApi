...
/* loaded from: ohos2.2.0.3.jar:ohos/global/icu/text/TimeZoneFormat.class */
public class TimeZoneFormat extends UFormat implements Freezable<TimeZoneFormat>, Serializable {

    /* loaded from: ohos2.2.0.3.jar:ohos/global/icu/text/TimeZoneFormat$GMTOffsetPatternType.class */
    ...
    /* loaded from: ohos2.2.0.3.jar:ohos/global/icu/text/TimeZoneFormat$ParseOption.class */
    public enum ParseOption {
        ALL_STYLES,
        TZ_DATABASE_ABBREVIATIONS
    }

    /* loaded from: ohos2.2.0.3.jar:ohos/global/icu/text/TimeZoneFormat$Style.class */
    public enum Style {
        GENERIC_LOCATION,
        GENERIC_LONG,
        GENERIC_SHORT,
    ...
    /* loaded from: ohos2.2.0.3.jar:ohos/global/icu/text/TimeZoneFormat$TimeType.class */
