...
/* loaded from: ohos2.0.1.95.jar:ohos/event/notification/NotificationConstant.class */
public final class NotificationConstant {
    ...
    /* loaded from: ohos2.0.1.95.jar:ohos/event/notification/NotificationConstant$DisturbMode.class */
    ...
    /* loaded from: ohos2.0.1.95.jar:ohos/event/notification/NotificationConstant$InputEditType.class */
    ...
    /* loaded from: ohos2.0.1.95.jar:ohos/event/notification/NotificationConstant$InputsSource.class */
    public enum InputsSource {
        FREE_FORM_INPUT,
        OPTION
    }

    /* loaded from: ohos2.0.1.95.jar:ohos/event/notification/NotificationConstant$SemanticActionButton.class */
