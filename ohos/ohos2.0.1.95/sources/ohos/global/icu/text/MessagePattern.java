...
/* loaded from: ohos2.0.1.95.jar:ohos/global/icu/text/MessagePattern.class */
public final class MessagePattern implements Cloneable, Freezable<MessagePattern> {
    ...
    /* loaded from: ohos2.0.1.95.jar:ohos/global/icu/text/MessagePattern$ApostropheMode.class */
    ...
    /* loaded from: ohos2.0.1.95.jar:ohos/global/icu/text/MessagePattern$ArgType.class */
    public enum ArgType {
        NONE,
        SIMPLE,
        CHOICE,
    ...
    /* loaded from: ohos2.0.1.95.jar:ohos/global/icu/text/MessagePattern$Part.class */
    public static final class Part {
        ...
        /* loaded from: ohos2.0.1.95.jar:ohos/global/icu/text/MessagePattern$Part$Type.class */
        public enum Type {
            MSG_START,
            MSG_LIMIT,
            SKIP_SYNTAX,
