...
/* loaded from: ohos2.0.1.95.jar:ohos/data/DatabaseFileConfig.class */
public class DatabaseFileConfig {
    DatabaseFileConfig(Builder builder) {
    ...
    /* loaded from: ohos2.0.1.95.jar:ohos/data/DatabaseFileConfig$Builder.class */
