...
/* loaded from: ohos2.0.1.95.jar:ohos/agp/components/ComponentProvider.class */
public class ComponentProvider implements Sequenceable {
    ...
    public Action setProgressBar(int viewId, int max, int progress, boolean indeterminate) {
        throw new RuntimeException("Stub!");
    }

    public Action setPadding(int viewId, int top, int bottom, int left, int right) {
        throw new RuntimeException("Stub!");
    }

    public Action setText(int viewId, String text) {
        throw new RuntimeException("Stub!");
    }
    ...
    public Action setString(int viewId, String methodName, String value) {
        throw new RuntimeException("Stub!");
    }

    public Action setFloat(int viewId, String methodName, float value) {
        throw new RuntimeException("Stub!");
    }

    public Action setDouble(int viewId, String methodName, double value) {
        throw new RuntimeException("Stub!");
    }

    public Action setLong(int viewId, String methodName, long value) {
        throw new RuntimeException("Stub!");
    }

    public Action setBoolean(int viewId, String methodName, boolean value) {
        throw new RuntimeException("Stub!");
    }

    public Action setPixelMap(int viewId, String methodName, PixelMap value) {
        throw new RuntimeException("Stub!");
    }

    public Action setImagePixelMap(int viewId, PixelMap pixelMap) {
        throw new RuntimeException("Stub!");
    }

    public Action setBackgroundPixelMap(int viewId, PixelMap pixelMap) {
        throw new RuntimeException("Stub!");
    }
    ...
    /* loaded from: ohos2.0.1.95.jar:ohos/agp/components/ComponentProvider$Action.class */
    ...
    /* loaded from: ohos2.0.1.95.jar:ohos/agp/components/ComponentProvider$ComponentProviderException.class */
    public static class ComponentProviderException extends RuntimeException {
        public ComponentProviderException(String message) {
            throw new RuntimeException("Stub!");
        }

        public ComponentProviderException(Throwable t) {
            throw new RuntimeException("Stub!");
        }
    }
}
