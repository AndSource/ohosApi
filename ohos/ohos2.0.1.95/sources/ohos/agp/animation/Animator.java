...
/* loaded from: ohos2.0.1.95.jar:ohos/agp/animation/Animator.class */
public abstract class Animator {
    ...
    /* loaded from: ohos2.0.1.95.jar:ohos/agp/animation/Animator$LoopedListener.class */
    public interface LoopedListener {
        void onRepeat(Animator animator);
    }

    /* loaded from: ohos2.0.1.95.jar:ohos/agp/animation/Animator$StateChangedListener.class */
    ...
    /* loaded from: ohos2.0.1.95.jar:ohos/agp/animation/Animator$CurveType.class */
