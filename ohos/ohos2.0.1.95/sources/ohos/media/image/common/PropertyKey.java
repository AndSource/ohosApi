...
/* loaded from: ohos2.0.1.95.jar:ohos/media/image/common/PropertyKey.class */
public final class PropertyKey {
    PropertyKey() {
        throw new RuntimeException("Stub!");
    }

    /* loaded from: ohos2.0.1.95.jar:ohos/media/image/common/PropertyKey$Exif.class */
    ...
    /* loaded from: ohos2.0.1.95.jar:ohos/media/image/common/PropertyKey$GIF.class */
