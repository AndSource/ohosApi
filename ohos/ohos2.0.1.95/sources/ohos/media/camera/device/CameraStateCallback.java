...
/* loaded from: ohos2.0.1.95.jar:ohos/media/camera/device/CameraStateCallback.class */
public abstract class CameraStateCallback {

    @Retention(RetentionPolicy.CLASS)
    /* loaded from: ohos2.0.1.95.jar:ohos/media/camera/device/CameraStateCallback$ErrorCode.class */
