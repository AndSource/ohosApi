...
/* loaded from: ohos2.1.1.21.jar:ohos/utils/geo/Rect.class */
public class Rect implements Sequenceable {
    public static final Sequenceable.Producer<Rect> PRODUCER = null;
    public int bottom;
    public int left;
    public int right;
    public int top;
    ...
    /* loaded from: ohos2.1.1.21.jar:ohos/utils/geo/Rect$RotationEnum.class */
