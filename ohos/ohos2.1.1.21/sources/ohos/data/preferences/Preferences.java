...
/* loaded from: ohos2.1.1.21.jar:ohos/data/preferences/Preferences.class */
public interface Preferences {
    public static final int MAX_KEY_LENGTH = 80;
    public static final int MAX_VALUE_LENGTH = 8192;

    /* loaded from: ohos2.1.1.21.jar:ohos/data/preferences/Preferences$PreferencesObserver.class */
