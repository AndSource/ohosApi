...
/* loaded from: ohos2.1.1.21.jar:ohos/agp/components/SearchBar.class */
public class SearchBar extends DirectionalLayout {

    /* loaded from: ohos2.1.1.21.jar:ohos/agp/components/SearchBar$FoldListener.class */
    public interface FoldListener {
        boolean onFold();
    }

    /* loaded from: ohos2.1.1.21.jar:ohos/agp/components/SearchBar$QueryListener.class */
