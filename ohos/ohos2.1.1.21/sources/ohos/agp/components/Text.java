...
/* loaded from: ohos2.1.1.21.jar:ohos/agp/components/Text.class */
public class Text extends Component {
    public static final int AUTO_CURSOR_POSITION = -1;
    public static final int AUTO_SCROLLING_FOREVER = -1;

    /* loaded from: ohos2.1.1.21.jar:ohos/agp/components/Text$EditorActionListener.class */
    public interface EditorActionListener {
        boolean onTextEditorAction(int i);
    }

    /* loaded from: ohos2.1.1.21.jar:ohos/agp/components/Text$TextColorObserver.class */
    public interface TextColorObserver {
        void onTextColorChanged(int i, int i2);
    }

    /* loaded from: ohos2.1.1.21.jar:ohos/agp/components/Text$TextObserver.class */
    public interface TextObserver {
        void onTextUpdated(String str, int i, int i2, int i3);
    }

    /* loaded from: ohos2.1.1.21.jar:ohos/agp/components/Text$TextSizeObserver.class */
    public interface TextSizeObserver {
        void onTextSizeChanged(int i, int i2);
    }

    /* loaded from: ohos2.1.1.21.jar:ohos/agp/components/Text$TextSizeType.class */
    ...
    /* loaded from: ohos2.1.1.21.jar:ohos/agp/components/Text$TruncationMode.class */
