...
/* loaded from: ohos2.1.1.21.jar:ohos/agp/render/render3d/Engine.class */
public interface Engine {

    /* loaded from: ohos2.1.1.21.jar:ohos/agp/render/render3d/Engine$RenderBackend.class */
    public enum RenderBackend {
        OPEN_GL_ES,
        VULKAN
    }

    /* loaded from: ohos2.1.1.21.jar:ohos/agp/render/render3d/Engine$RenderMode.class */
    public enum RenderMode {
        RENDER_IF_DIRTY,
        ALWAYS
    }

    /* loaded from: ohos2.1.1.21.jar:ohos/agp/render/render3d/Engine$RenderNodeGraphType.class */
    ...
    /* loaded from: ohos2.1.1.21.jar:ohos/agp/render/render3d/Engine$Time.class */
    ...
    /* loaded from: ohos2.1.1.21.jar:ohos/agp/render/render3d/Engine$RenderNodeGraph.class */
