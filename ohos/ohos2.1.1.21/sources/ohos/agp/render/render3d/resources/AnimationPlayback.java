...
/* loaded from: ohos2.1.1.21.jar:ohos/agp/render/render3d/resources/AnimationPlayback.class */
public interface AnimationPlayback {
    public static final int REPEAT_COUNT_INFINITE = Integer.MAX_VALUE;

    /* loaded from: ohos2.1.1.21.jar:ohos/agp/render/render3d/resources/AnimationPlayback$State.class */
    public enum State {
        STOP,
        PLAY,
        PAUSE
