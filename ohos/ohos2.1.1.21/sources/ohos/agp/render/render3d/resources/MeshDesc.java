...
/* loaded from: ohos2.1.1.21.jar:ohos/agp/render/render3d/resources/MeshDesc.class */
public class MeshDesc {
    ...
    /* loaded from: ohos2.1.1.21.jar:ohos/agp/render/render3d/resources/MeshDesc$PrimitiveDesc.class */
    public static class PrimitiveDesc {
        public PrimitiveDesc() {
            throw new RuntimeException("Stub!");
        }
