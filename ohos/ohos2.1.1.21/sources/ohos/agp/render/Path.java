...
/* loaded from: ohos2.1.1.21.jar:ohos/agp/render/Path.class */
public class Path {
    public Path() {
    ...
    /* loaded from: ohos2.1.1.21.jar:ohos/agp/render/Path$AddPathMode.class */
    ...
    /* loaded from: ohos2.1.1.21.jar:ohos/agp/render/Path$ArcSize.class */
    public enum ArcSize {
        SMALL_SIZE,
        LARGE_SIZE;
    ...
    /* loaded from: ohos2.1.1.21.jar:ohos/agp/render/Path$Direction.class */
    ...
    /* loaded from: ohos2.1.1.21.jar:ohos/agp/render/Path$FillType.class */
