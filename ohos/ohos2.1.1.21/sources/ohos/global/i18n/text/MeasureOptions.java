...
/* loaded from: ohos2.1.1.21.jar:ohos/global/i18n/text/MeasureOptions.class */
public class MeasureOptions {

    /* loaded from: ohos2.1.1.21.jar:ohos/global/i18n/text/MeasureOptions$Style.class */
    public enum Style {
        AUTO_STYLE_ON,
        AUTO_STYLE_OFF
    }
    ...
    /* loaded from: ohos2.1.1.21.jar:ohos/global/i18n/text/MeasureOptions$FormatStyle.class */
    ...
    /* loaded from: ohos2.1.1.21.jar:ohos/global/i18n/text/MeasureOptions$Unit.class */
    public enum Unit {
        AREA_UK_ACRE,
        AREA_SI_HECTARE,
    ...
    /* loaded from: ohos2.1.1.21.jar:ohos/global/i18n/text/MeasureOptions$Usage.class */
    public enum Usage {
        DEFAULT,
        AREA_LAND_AGRICULT,
        AREA_LAND_COMMERCL,
