...
/* loaded from: ohos2.1.1.21.jar:ohos/hiviewdfx/HiChecker.class */
public class HiChecker {

    /* loaded from: ohos2.1.1.21.jar:ohos/hiviewdfx/HiChecker$OnCautionListener.class */
    public interface OnCautionListener {
        void onCautionFound(Caution caution);
    }

    /* loaded from: ohos2.1.1.21.jar:ohos/hiviewdfx/HiChecker$Rule.class */
    public enum Rule {
        CAUTION_BY_LOG,
        CAUTION_BY_CRASH,
        CHECK_FILE_READ,
