...
/* loaded from: ohos2.1.1.21.jar:ohos/media/camera/device/CameraStateCallback.class */
public abstract class CameraStateCallback {

    @Retention(RetentionPolicy.CLASS)
    /* loaded from: ohos2.1.1.21.jar:ohos/media/camera/device/CameraStateCallback$ErrorCode.class */
