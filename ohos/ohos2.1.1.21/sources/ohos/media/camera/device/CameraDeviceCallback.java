...
/* loaded from: ohos2.1.1.21.jar:ohos/media/camera/device/CameraDeviceCallback.class */
public abstract class CameraDeviceCallback {

    @Retention(RetentionPolicy.CLASS)
    /* loaded from: ohos2.1.1.21.jar:ohos/media/camera/device/CameraDeviceCallback$CameraStatus.class */
    ...
    @Retention(RetentionPolicy.CLASS)
    /* loaded from: ohos2.1.1.21.jar:ohos/media/camera/device/CameraDeviceCallback$FlashlightStatus.class */
