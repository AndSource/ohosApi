...
/* loaded from: ohos2.1.1.21.jar:ohos/media/camera/device/CameraAbility.class */
public interface CameraAbility {

    @Retention(RetentionPolicy.CLASS)
    /* loaded from: ohos2.1.1.21.jar:ohos/media/camera/device/CameraAbility$CameraRunningMode.class */
