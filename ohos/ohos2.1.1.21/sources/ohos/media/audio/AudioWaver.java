...
/* loaded from: ohos2.1.1.21.jar:ohos/media/audio/AudioWaver.class */
public class AudioWaver {

    /* loaded from: ohos2.1.1.21.jar:ohos/media/audio/AudioWaver$FrequencyDataObserver.class */
    public interface FrequencyDataObserver {
        void onFrequencyData(byte[] bArr, int i);
    }

    /* loaded from: ohos2.1.1.21.jar:ohos/media/audio/AudioWaver$WaveDataObserver.class */
