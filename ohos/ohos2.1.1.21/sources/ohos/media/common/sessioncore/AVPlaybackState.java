...
/* loaded from: ohos2.1.1.21.jar:ohos/media/common/sessioncore/AVPlaybackState.class */
public final class AVPlaybackState implements Sequenceable {
    ...
    /* loaded from: ohos2.1.1.21.jar:ohos/media/common/sessioncore/AVPlaybackState$AVPlaybackCustomAction.class */
    public static final class AVPlaybackCustomAction implements Sequenceable {
        ...
        /* loaded from: ohos2.1.1.21.jar:ohos/media/common/sessioncore/AVPlaybackState$AVPlaybackCustomAction$Builder.class */
    ...
    /* loaded from: ohos2.1.1.21.jar:ohos/media/common/sessioncore/AVPlaybackState$Builder.class */
    public static final class Builder {
        public Builder() {
            throw new RuntimeException("Stub!");
        }
