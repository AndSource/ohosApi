...
public interface CameraAbility {
  ...
  boolean isFormatSupported(int paramInt);
  
  <T> boolean isSurfaceClassSupported(Class<T> paramClass);
...
/* Location:              /Users/sanbo/tools/HarmonOS_Legacy_sdk/java/2.1.1.21/api/ohos.jar!/ohos/media/camera/device/CameraAbility.class
