...
/* loaded from: ohos3.0.0.1.jar:ohos/vibrator/bean/VibrationPattern.class */
public class VibrationPattern {
    ...
    public static final String VIBRATOR_TYPE_WATCH_CROWN_STRENGTH0 = "watchhaptic.crown.strength0";
    ...
    public static final String VIBRATOR_TYPE_WATCH_POWER_OFF = "watchhaptic.power.off";
    public static final String VIBRATOR_TYPE_WATCH_POWER_ON = "watchhaptic.power.on";
    ...
    public static final String VIBRATOR_TYPE_WATCH_SPARETYPE_STRENGTH1 = "watchhaptic.sparetype.strength1";
    public static final String VIBRATOR_TYPE_WATCH_SPARETYPE_STRENGTH2 = "watchhaptic.sparetype.strength2";
    public static final String VIBRATOR_TYPE_WATCH_SPARETYPE_STRENGTH3 = "watchhaptic.sparetype.strength3";
    public static final String VIBRATOR_TYPE_WATCH_SPO2MEASURE_FINISH = "watchhaptic.spo2measure.finish";
    public static final String VIBRATOR_TYPE_WATCH_SYSTEMTYPE_STRENGTH0 = "watchhaptic.systemtype.strength0";
    ...
    VibrationPattern(int duration, int intensity) {
        throw new RuntimeException("Stub!");
    }

    public static final VibrationPattern createSingle(int duration, int intensity) {
        throw new RuntimeException("Stub!");
    }

    public static final VibrationPattern createPeriod(int[] timing, int[] intensities, int count) {
        throw new RuntimeException("Stub!");
    }

    public static final VibrationPattern createPeriod(int[] timing, int count) {
        throw new RuntimeException("Stub!");
    }
    ...
    /* loaded from: ohos3.0.0.1.jar:ohos/vibrator/bean/VibrationPattern$EffectFlagType.class */
