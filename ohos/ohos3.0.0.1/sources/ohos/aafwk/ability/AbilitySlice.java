...
/* loaded from: ohos3.0.0.1.jar:ohos/aafwk/ability/AbilitySlice.class */
public class AbilitySlice extends AbilityContext implements ILifecycle {
    ...
    public void acquireFormState(Intent intent, FormCallback callback) throws FormException {
        throw new RuntimeException("Stub!");
    }
    ...
    /* loaded from: ohos3.0.0.1.jar:ohos/aafwk/ability/AbilitySlice$FormCallback.class */
