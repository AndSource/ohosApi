...
/* loaded from: ohos3.0.0.1.jar:ohos/aafwk/ability/DataAbilityHelper.class */
public class DataAbilityHelper {
    ...
    public static DataAbilityHelper create(Context context) {
        throw new RuntimeException("Stub!");
    }
    ...
    public static DataAbilityHelper create(Context context, Uri uri) {
        throw new RuntimeException("Stub!");
    }
    ...
    public static DataAbilityHelper create(Context context, Uri uri, boolean tryBind) {
        throw new RuntimeException("Stub!");
    }

    public static DataAbilityHelper create(Context context, Uri uri, boolean tryBind, int flag) {
        throw new RuntimeException("Stub!");
    }
