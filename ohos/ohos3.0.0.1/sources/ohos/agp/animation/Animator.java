...
/* loaded from: ohos3.0.0.1.jar:ohos/agp/animation/Animator.class */
public abstract class Animator {
    ...
    /* loaded from: ohos3.0.0.1.jar:ohos/agp/animation/Animator$LoopedListener.class */
    public interface LoopedListener {
        void onRepeat(Animator animator);
    }

    /* loaded from: ohos3.0.0.1.jar:ohos/agp/animation/Animator$StateChangedListener.class */
    ...
    /* loaded from: ohos3.0.0.1.jar:ohos/agp/animation/Animator$TimelineCurve.class */
    ...
    /* loaded from: ohos3.0.0.1.jar:ohos/agp/animation/Animator$CurveType.class */
