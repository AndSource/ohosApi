...
/* loaded from: ohos3.0.0.1.jar:ohos/agp/components/ComponentState.class */
public class ComponentState {
    public static final int COMPONENT_STATE_CHECKED = 64;
    public static final int COMPONENT_STATE_DISABLED = 32;
    public static final int COMPONENT_STATE_DRAG_ENTERED = 128;
    public static final int COMPONENT_STATE_DRAG_RESPONDED = 256;
    ...
    public static final int COMPONENT_STATE_WINDOW_FOCUSED = 16;
