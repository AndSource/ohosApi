...
/* loaded from: ohos3.0.0.1.jar:ohos/agp/components/SearchBar.class */
public class SearchBar extends DirectionalLayout {

    /* loaded from: ohos3.0.0.1.jar:ohos/agp/components/SearchBar$FoldListener.class */
    public interface FoldListener {
        boolean onFold();
    }

    /* loaded from: ohos3.0.0.1.jar:ohos/agp/components/SearchBar$QueryListener.class */
