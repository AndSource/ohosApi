...
/* loaded from: ohos3.0.0.1.jar:ohos/agp/components/ComponentProvider.class */
public class ComponentProvider implements Sequenceable {
    ...
    public Action setAccessibilityDescription(int componentId, String description) {
        throw new RuntimeException("Stub!");
    }

    public Action setClipToContourEnabled(int componentId, boolean enable) {
        throw new RuntimeException("Stub!");
    }
    ...
    public Action setInt(int componentId, String methodName, int value) {
        throw new RuntimeException("Stub!");
    }
    ...
    public Action setIntentAgent(int componentId, IntentAgent intent) {
        throw new RuntimeException("Stub!");
    }

    /* loaded from: ohos3.0.0.1.jar:ohos/agp/components/ComponentProvider$Action.class */
    ...
    /* loaded from: ohos3.0.0.1.jar:ohos/agp/components/ComponentProvider$ComponentProviderException.class */
