...
/* loaded from: ohos3.0.0.1.jar:ohos/agp/components/DirectionalLayout.class */
public class DirectionalLayout extends ComponentContainer {
    ...
    public void setLayoutBaselined(boolean baselined) {
        throw new RuntimeException("Stub!");
    }

    public boolean isLayoutBaselined() {
        throw new RuntimeException("Stub!");
    }

    /* loaded from: ohos3.0.0.1.jar:ohos/agp/components/DirectionalLayout$LayoutConfig.class */
