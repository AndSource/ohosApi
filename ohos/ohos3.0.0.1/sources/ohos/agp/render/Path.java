...
/* loaded from: ohos3.0.0.1.jar:ohos/agp/render/Path.class */
public class Path {
    public Path() {
    ...
    /* loaded from: ohos3.0.0.1.jar:ohos/agp/render/Path$AddPathMode.class */
    ...
    /* loaded from: ohos3.0.0.1.jar:ohos/agp/render/Path$ArcSize.class */
    public enum ArcSize {
        SMALL_SIZE,
        LARGE_SIZE;
    ...
    /* loaded from: ohos3.0.0.1.jar:ohos/agp/render/Path$Direction.class */
    ...
    /* loaded from: ohos3.0.0.1.jar:ohos/agp/render/Path$FillType.class */
