...
/* loaded from: ohos3.0.0.1.jar:ohos/agp/render/render3d/components/CameraComponent.class */
public class CameraComponent implements Component {
    public static final int CAMERA_FLAG_SHADOW_BIT = 1;

    /* loaded from: ohos3.0.0.1.jar:ohos/agp/render/render3d/components/CameraComponent$CameraType.class */
