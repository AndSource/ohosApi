...
/* loaded from: ohos3.0.0.1.jar:ohos/agp/window/dialog/IDialog.class */
public interface IDialog {
    ...
    /* loaded from: ohos3.0.0.1.jar:ohos/agp/window/dialog/IDialog$CheckBoxClickedListener.class */
    public interface CheckBoxClickedListener {
        void onClick(IDialog iDialog, int i, boolean z);
    }

    /* loaded from: ohos3.0.0.1.jar:ohos/agp/window/dialog/IDialog$ClickedListener.class */
    public interface ClickedListener {
        void onClick(IDialog iDialog, int i);
    }

    /* loaded from: ohos3.0.0.1.jar:ohos/agp/window/dialog/IDialog$ItemClickedListener.class */
    public interface ItemClickedListener {
        void onClick(IDialog iDialog, int i);
    }

    /* loaded from: ohos3.0.0.1.jar:ohos/agp/window/dialog/IDialog$KeyboardCallback.class */
