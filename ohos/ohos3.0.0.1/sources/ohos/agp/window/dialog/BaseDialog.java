...
/* loaded from: ohos3.0.0.1.jar:ohos/agp/window/dialog/BaseDialog.class */
public class BaseDialog implements IDialog {

    /* loaded from: ohos3.0.0.1.jar:ohos/agp/window/dialog/BaseDialog$DialogListener.class */
    public interface DialogListener {
        boolean isTouchOutside();
    }

    /* loaded from: ohos3.0.0.1.jar:ohos/agp/window/dialog/BaseDialog$DisplayCallback.class */
    public interface DisplayCallback {
        void onDisplay(IDialog iDialog);
    }

    /* loaded from: ohos3.0.0.1.jar:ohos/agp/window/dialog/BaseDialog$RemoveCallback.class */
