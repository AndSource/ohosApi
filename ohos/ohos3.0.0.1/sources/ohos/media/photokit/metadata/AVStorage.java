...
/* loaded from: ohos3.0.0.1.jar:ohos/media/photokit/metadata/AVStorage.class */
public final class AVStorage {
    public static final Uri MEDIA_AUTH_HEAD_URI = null;

    /* loaded from: ohos3.0.0.1.jar:ohos/media/photokit/metadata/AVStorage$AVBaseColumns.class */
    ...
    /* loaded from: ohos3.0.0.1.jar:ohos/media/photokit/metadata/AVStorage$Audio.class */
    public static final class Audio {
        ...
        /* loaded from: ohos3.0.0.1.jar:ohos/media/photokit/metadata/AVStorage$Audio$Albums.class */
        ...
        /* loaded from: ohos3.0.0.1.jar:ohos/media/photokit/metadata/AVStorage$Audio$Artists.class */
        public static final class Artists implements AVBaseColumns {
            ...
            /* loaded from: ohos3.0.0.1.jar:ohos/media/photokit/metadata/AVStorage$Audio$Artists$Albums.class */
        ...
        /* loaded from: ohos3.0.0.1.jar:ohos/media/photokit/metadata/AVStorage$Audio$Genres.class */
        public static final class Genres implements AVBaseColumns {
            ...
            /* loaded from: ohos3.0.0.1.jar:ohos/media/photokit/metadata/AVStorage$Audio$Genres$Members.class */
        ...
        /* loaded from: ohos3.0.0.1.jar:ohos/media/photokit/metadata/AVStorage$Audio$Media.class */
        ...
        /* loaded from: ohos3.0.0.1.jar:ohos/media/photokit/metadata/AVStorage$Audio$Playlists.class */
        public static final class Playlists implements AVBaseColumns {
            ...
            /* loaded from: ohos3.0.0.1.jar:ohos/media/photokit/metadata/AVStorage$Audio$Playlists$Members.class */
            public static final class Members implements AVBaseColumns {
                Members() {
                    throw new RuntimeException("Stub!");
                }
    ...
    /* loaded from: ohos3.0.0.1.jar:ohos/media/photokit/metadata/AVStorage$Downloads.class */
    ...
    /* loaded from: ohos3.0.0.1.jar:ohos/media/photokit/metadata/AVStorage$Files.class */
    ...
    /* loaded from: ohos3.0.0.1.jar:ohos/media/photokit/metadata/AVStorage$Images.class */
    public static final class Images {
        Images() {
            throw new RuntimeException("Stub!");
        }

        /* loaded from: ohos3.0.0.1.jar:ohos/media/photokit/metadata/AVStorage$Images$Media.class */
        public static final class Media implements AVBaseColumns {
            public static final Uri EXTERNAL_DATA_ABILITY_URI = null;
            public static final Uri INTERNAL_DATA_ABILITY_URI = null;
    ...
    /* loaded from: ohos3.0.0.1.jar:ohos/media/photokit/metadata/AVStorage$Video.class */
    public static final class Video {
        Video() {
            throw new RuntimeException("Stub!");
        }

        /* loaded from: ohos3.0.0.1.jar:ohos/media/photokit/metadata/AVStorage$Video$Media.class */
        public static final class Media implements AVBaseColumns {
            public static final Uri EXTERNAL_DATA_ABILITY_URI = null;
            public static final Uri INTERNAL_DATA_ABILITY_URI = null;
