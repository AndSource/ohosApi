...
/* loaded from: ohos3.0.0.1.jar:ohos/media/camera/device/CameraInfo.class */
public interface CameraInfo {

    @Retention(RetentionPolicy.CLASS)
    /* loaded from: ohos3.0.0.1.jar:ohos/media/camera/device/CameraInfo$DeviceLinkType.class */
    ...
    @Retention(RetentionPolicy.CLASS)
    /* loaded from: ohos3.0.0.1.jar:ohos/media/camera/device/CameraInfo$FacingType.class */
