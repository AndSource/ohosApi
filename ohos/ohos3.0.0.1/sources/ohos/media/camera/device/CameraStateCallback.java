...
/* loaded from: ohos3.0.0.1.jar:ohos/media/camera/device/CameraStateCallback.class */
public abstract class CameraStateCallback {

    @Retention(RetentionPolicy.CLASS)
    /* loaded from: ohos3.0.0.1.jar:ohos/media/camera/device/CameraStateCallback$ErrorCode.class */
