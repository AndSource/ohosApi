...
/* loaded from: ohos3.0.0.1.jar:ohos/media/camera/device/CameraAbility.class */
public interface CameraAbility {

    @Retention(RetentionPolicy.CLASS)
    /* loaded from: ohos3.0.0.1.jar:ohos/media/camera/device/CameraAbility$CameraRunningMode.class */
