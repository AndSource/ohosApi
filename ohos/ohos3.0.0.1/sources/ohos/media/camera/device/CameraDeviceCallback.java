...
/* loaded from: ohos3.0.0.1.jar:ohos/media/camera/device/CameraDeviceCallback.class */
public abstract class CameraDeviceCallback {

    @Retention(RetentionPolicy.CLASS)
    /* loaded from: ohos3.0.0.1.jar:ohos/media/camera/device/CameraDeviceCallback$CameraStatus.class */
    ...
    @Retention(RetentionPolicy.CLASS)
    /* loaded from: ohos3.0.0.1.jar:ohos/media/camera/device/CameraDeviceCallback$FlashlightStatus.class */
