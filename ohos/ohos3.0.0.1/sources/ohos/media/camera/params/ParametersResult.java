...
/* loaded from: ohos3.0.0.1.jar:ohos/media/camera/params/ParametersResult.class */
public interface ParametersResult {

    @Retention(RetentionPolicy.CLASS)
    /* loaded from: ohos3.0.0.1.jar:ohos/media/camera/params/ParametersResult$State.class */
