...
/* loaded from: ohos3.0.0.1.jar:ohos/media/camera/params/FaceDetectionResult.class */
public interface FaceDetectionResult {

    @Retention(RetentionPolicy.CLASS)
    /* loaded from: ohos3.0.0.1.jar:ohos/media/camera/params/FaceDetectionResult$State.class */
