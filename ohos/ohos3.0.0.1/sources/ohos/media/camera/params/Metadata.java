...
/* loaded from: ohos3.0.0.1.jar:ohos/media/camera/params/Metadata.class */
public final class Metadata {

    @Retention(RetentionPolicy.CLASS)
    /* loaded from: ohos3.0.0.1.jar:ohos/media/camera/params/Metadata$AeMode.class */
    ...
    @Retention(RetentionPolicy.CLASS)
    /* loaded from: ohos3.0.0.1.jar:ohos/media/camera/params/Metadata$AeTrigger.class */
    ...
    @Retention(RetentionPolicy.CLASS)
    /* loaded from: ohos3.0.0.1.jar:ohos/media/camera/params/Metadata$AfMode.class */
    ...
    @Retention(RetentionPolicy.CLASS)
    /* loaded from: ohos3.0.0.1.jar:ohos/media/camera/params/Metadata$AfTrigger.class */
    ...
    @Retention(RetentionPolicy.CLASS)
    /* loaded from: ohos3.0.0.1.jar:ohos/media/camera/params/Metadata$AwbMode.class */
    ...
    @Retention(RetentionPolicy.CLASS)
    /* loaded from: ohos3.0.0.1.jar:ohos/media/camera/params/Metadata$FaceDetectionType.class */
    ...
    @Retention(RetentionPolicy.CLASS)
    /* loaded from: ohos3.0.0.1.jar:ohos/media/camera/params/Metadata$FlashMode.class */
