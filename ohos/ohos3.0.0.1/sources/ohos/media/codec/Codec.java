...
/* loaded from: ohos3.0.0.1.jar:ohos/media/codec/Codec.class */
public class Codec {
    public static final int VIDEO_SCALE_TYPE_CROP = 2;
    public static final int VIDEO_SCALE_TYPE_FIT = 1;

    /* loaded from: ohos3.0.0.1.jar:ohos/media/codec/Codec$ICodecListener.class */
    ...
    public boolean stopVideoSurface() {
        throw new RuntimeException("Stub!");
    }

    public Map<Integer, String> obtainCodecName() {
        throw new RuntimeException("Stub!");
    }

    public CodecDescription obtainCodecDescription() {
        throw new RuntimeException("Stub!");
    }

    public PixelMap obtainOutputPixelMap(int index) {
        throw new RuntimeException("Stub!");
    }

    public PixelMap obtainInputPixelMap(int index) {
        throw new RuntimeException("Stub!");
    }

    public Surface createLastingVideoSurface() {
        throw new RuntimeException("Stub!");
    }

    public boolean setLastingVideoSurface(Surface lastingSurface) {
        throw new RuntimeException("Stub!");
    }

    public int getInputBufferIndex(long timeout) {
        throw new RuntimeException("Stub!");
    }
