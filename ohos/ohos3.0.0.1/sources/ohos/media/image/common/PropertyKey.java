...
/* loaded from: ohos3.0.0.1.jar:ohos/media/image/common/PropertyKey.class */
public final class PropertyKey {
    PropertyKey() {
        throw new RuntimeException("Stub!");
    }

    /* loaded from: ohos3.0.0.1.jar:ohos/media/image/common/PropertyKey$Exif.class */
    ...
    /* loaded from: ohos3.0.0.1.jar:ohos/media/image/common/PropertyKey$GIF.class */
