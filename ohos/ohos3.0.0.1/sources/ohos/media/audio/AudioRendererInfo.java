...
/* loaded from: ohos3.0.0.1.jar:ohos/media/audio/AudioRendererInfo.class */
public final class AudioRendererInfo {
    ...
    /* loaded from: ohos3.0.0.1.jar:ohos/media/audio/AudioRendererInfo$AudioStreamOutputFlag.class */
    ...
    /* loaded from: ohos3.0.0.1.jar:ohos/media/audio/AudioRendererInfo$Builder.class */
    public static class Builder {
        ...
        public Builder privilegedMode(PrivilegedMode privilegedMode) {
            throw new RuntimeException("Stub!");
        }
    ...
    /* loaded from: ohos3.0.0.1.jar:ohos/media/audio/AudioRendererInfo$PrivilegedMode.class */
    public enum PrivilegedMode {
        DEFAULT,
        LOW_LATENCY,
        LOW_POWER;

        public static PrivilegedMode valueOf(int value) {
            throw new RuntimeException("Stub!");
        }
