...
/* loaded from: ohos3.0.0.1.jar:ohos/media/common/Format.class */
public class Format {
    ...
    public static final Key<Scope<Integer>> COMPLEXITY_SCOPE = null;
    public static final Key<Scope<Double>> FRAME_RATE_SCOPE_FOR_SPECIFIC_SIZE = null;
    public static final Key<Integer> HEIGHT_ALIGNMENT = null;
    public static final Key<Scope<Integer>> HEIGHT_SCOPE = null;
    public static final Key<Integer> MAX_INSTANCES = null;
    ...
    /* loaded from: ohos3.0.0.1.jar:ohos/media/common/Format$FormatArrays.class */
    ...
    /* loaded from: ohos3.0.0.1.jar:ohos/media/common/Format$Key.class */
