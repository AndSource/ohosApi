...
/* loaded from: ohos3.0.0.1.jar:ohos/event/notification/NotificationRequest.class */
public final class NotificationRequest implements Sequenceable {
    ...
    /* loaded from: ohos3.0.0.1.jar:ohos/event/notification/NotificationRequest$NotificationContent.class */
    ...
    /* loaded from: ohos3.0.0.1.jar:ohos/event/notification/NotificationRequest$NotificationConversationalContent.class */
    public static final class NotificationConversationalContent implements Sequenceable {
        ...
        /* loaded from: ohos3.0.0.1.jar:ohos/event/notification/NotificationRequest$NotificationConversationalContent$ConversationalMessage.class */
    ...
    /* loaded from: ohos3.0.0.1.jar:ohos/event/notification/NotificationRequest$NotificationLongTextContent.class */
    ...
    /* loaded from: ohos3.0.0.1.jar:ohos/event/notification/NotificationRequest$NotificationMediaContent.class */
    ...
    /* loaded from: ohos3.0.0.1.jar:ohos/event/notification/NotificationRequest$NotificationMultiLineContent.class */
    ...
    /* loaded from: ohos3.0.0.1.jar:ohos/event/notification/NotificationRequest$NotificationNormalContent.class */
    ...
    /* loaded from: ohos3.0.0.1.jar:ohos/event/notification/NotificationRequest$NotificationPictureContent.class */
