...
/* loaded from: ohos3.0.0.1.jar:ohos/global/icu/text/AlphabeticIndex.class */
public final class AlphabeticIndex<V> implements Iterable<Bucket<V>> {
    ...
    /* loaded from: ohos3.0.0.1.jar:ohos/global/icu/text/AlphabeticIndex$Bucket.class */
    public static class Bucket<V> implements Iterable<Record<V>> {

        /* loaded from: ohos3.0.0.1.jar:ohos/global/icu/text/AlphabeticIndex$Bucket$LabelType.class */
    ...
    /* loaded from: ohos3.0.0.1.jar:ohos/global/icu/text/AlphabeticIndex$ImmutableIndex.class */
    ...
    /* loaded from: ohos3.0.0.1.jar:ohos/global/icu/text/AlphabeticIndex$Record.class */
