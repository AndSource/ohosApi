...
/* loaded from: ohos3.0.0.1.jar:ohos/global/resource/solidxml/TypedAttribute.class */
public abstract class TypedAttribute {
    ...
    public abstract SolidXml getStateColorsValue() throws IOException, NotExistException, WrongTypeException;
    ...
    public static int computePixelValue(String original, Configuration config, DeviceCapability devCap, boolean truncate) throws WrongTypeException {
        throw new RuntimeException("Stub!");
    }
    ...
    /* loaded from: ohos3.0.0.1.jar:ohos/global/resource/solidxml/TypedAttribute$AttrData.class */
