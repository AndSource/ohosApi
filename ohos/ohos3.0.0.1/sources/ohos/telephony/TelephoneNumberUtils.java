...
/* loaded from: ohos3.0.0.1.jar:ohos/telephony/TelephoneNumberUtils.class */
public class TelephoneNumberUtils {
    ...
    public static int getIntlPrefixAndCCLen(String phoneNumber) {
        throw new RuntimeException("Stub!");
    }

    public static String replacePauseAndWaitChar(String phoneNumber) {
        throw new RuntimeException("Stub!");
    }
