...
/* loaded from: ohos3.0.0.1.jar:ohos/hiviewdfx/HiChecker.class */
public class HiChecker {

    /* loaded from: ohos3.0.0.1.jar:ohos/hiviewdfx/HiChecker$OnCautionListener.class */
    public interface OnCautionListener {
        void onCautionFound(Caution caution);
    }

    /* loaded from: ohos3.0.0.1.jar:ohos/hiviewdfx/HiChecker$Rule.class */
    public enum Rule {
        CAUTION_BY_LOG,
        CAUTION_BY_CRASH,
        CHECK_FILE_READ,
