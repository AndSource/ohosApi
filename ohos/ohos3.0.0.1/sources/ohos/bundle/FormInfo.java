...
/* loaded from: ohos3.0.0.1.jar:ohos/bundle/FormInfo.class */
public class FormInfo implements Sequenceable {
    public static final Sequenceable.Producer<FormInfo> PRODUCER = null;

    /* loaded from: ohos3.0.0.1.jar:ohos/bundle/FormInfo$FormType.class */
    ...
    /* loaded from: ohos3.0.0.1.jar:ohos/bundle/FormInfo$CustomizeData.class */
